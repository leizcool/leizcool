...
- Azure DevOps CI/CD pipeline implementation - Azure DevOps services](https://github.com/alelimc/Diet_Planner-Comp313-003.git)
- Networking for Software Developers - An end-to-end IoT solution that uses the MQTT protocol (Python)](https://github.com/leizcool)
